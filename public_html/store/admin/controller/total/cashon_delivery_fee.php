<?php
class ControllerTotalCashonDeliveryFee extends Controller {
	private $error = array();

	public function index() {
		$this->load->language('total/cashon_delivery_fee');
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('total/cashon_delivery_fee', 'token=' . $this->session->data['token'], 'SSL')
		);

		$data['action'] = $this->url->link('total/cashon_delivery_fee', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('total/cashon_delivery_fee.tpl', $data));
	}

	protected function validate() {
		if (!$this->user->hasPermission('modify', 'total/cashon_delivery_fee')) {
